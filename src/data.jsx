const Data = {
  ...
  about: [
    ...
    다양한 직군의 사람들이 데이터를 자유롭게 가지고 놀 수 있도록 돕는 도구를 만드는데 관심이 많습니다.`,
  ...
  experiences: [
    {
      ...
      story: [
        ...
        `주요 기술 스택 (자주 사용): Javascript, Typescript, React(Hook, ContextAPI, Redux, Redux-saga), Vue(Vuex), Cypress, React-testing-library, Storybook, SQL, Redash, Zeppelin, Git.`,
        `기술 스택 (가끔 사용): Material UI, Figma, Python, Pandas, Tableau, Jenkins.`,
        `주요 협업 도구: Slack, Notion, Jira, Confluence Wiki, GitLab, Zoom ...`,
      ],
    },
    {
      ...
      story: [
        `네이버 클로바 AI의 NSML(Naver Smart Machine Learning)팀은 머신러닝 연구자를 돕는 플랫폼을 개발합니다.
        이곳에서 저는 머신러닝 실무자의 개발을 돕기 위한 위한 웹 기반 플랫폼을 만들었습니다.
        웹 프론트엔드 개발, UI/UX 리서치, 데이터 분석 및 시각화 등을 맡았습니다.`,
        `주요 기술 스택: TypeScript, React(+Hook), Material-UI, Adobe XD`,
      ],
    },
    {
      ...
      story: [
        `캘리포니아 주립대학 데이비스 캠퍼스 컴퓨터공학과의 데이터 시각화 연구실 VIDI Labs에서 방문연구원으로 근무했습니다. 
          ...
          같은 데이터를 표현하는 다양한 시각화 알고리즘을 비교하고 여러 시각화를 조합하여 유저의 인터랙션을 유도하는 방법을 조사하고 적용시켰습니다.`,
        `리서치와 아이디어 제안, 프로토타이핑을 통한 검증이 순환되며 효율적인 연구가 진행되었습니다. 
          데이터 처리에는 python, 시각화에는 React와 d3.js를 활용했습니다. 
          연구의 가치를 판단하는 안목을 길르고 영어 실력을 향상시켰습니다.`,
      ],
    },
    {
      ...
      story: [
        `학생들의 진로 및 학습 설계를 보조하는 웹 서비스인 미디어-인더스트리 링크의 유지 보수를 맡았습니다.
          HTML, CSS, Javascript, SQL(MySQL)을 사용하여, 강의목록 탐색 페이지와 선후배 질문 답변 게시판 등을 개발했습니다.  
          웹 서비스 개발 외에도 서비스 기획, 운영, 평가 업무 등을 진행했습니다. `,
    ...
    },
    {
      ...
      story: [
        `학교의 현장실습 프로그램으로 파견되어 인연을 맺었습니다. 파견 기간 종료 이후에도 2년간 프로젝트 단위로 프리랜서처럼 함께했습니다. 
          삼성전자 C Lab, 한국전자통신연구원 등의 외주 업무에 참여하고 산학 연계 연구도 진행하여 세편의 연구를 발표했습니다. 
          더더랩에서 근무하는 동안 웹 프론트엔드 개발 및 데이터 시각화를 맡으며 Javascript, TypeScript, Vue, d3.js, Firebase, Redis 등 다양한 웹 개발 기술 스택을 쌓았습니다.`,
  ...
  educations: [
    {
      course: "기술경영학 박사과정",
      where: "한양대학교",
      href: "https://mot.hanyang.ac.kr/",
      period: "2022.03 - (졸업년월 미정)",
      story: `IT 비즈니스의 성장 전략에 대해 공부합니다. 
        제품과 서비스의 성장을 위해 어떤 데이터를 어떤 방향에서 봐야할 지에 대한 전문성을 기르고자 진학했습니다.`,
    },
    {
      course: "미디어학 석사",
      where: "아주대학교",
      href: "https://dt.ajou.ac.kr/dt/edu/edu01.jsp",
      period: "2019.09 - 2022.02",
      story: `데이터 분석을 위한 웹 기반 시스템의 설계 및 개발에 대해 연구했습니다. 
        다양한 데이터 분석 도구를 설계하고, 개발하고, 평가했습니다. 
        머신러닝 모델 해석을 위한 시각 분석 시스템 연구로 석사학위를 받았습니다.`,
    },
    {
      course: "디지털미디어학 학사",
      where: "아주대학교",
      ...
      story: `웹 프론트엔드 개발, 유저 인터페이스 디자인, 데이터 시각화 등을 공부했습니다.
  ...
  researches: [
    {
      ...
      conf_title: "아주대학교 석사 학위 논문",
      conf_short: undefined,
      short_conf: "ajma",
      year: "2022",
      pdf: true,
      poster: false,
