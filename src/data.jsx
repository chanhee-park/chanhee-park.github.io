const Data = {
  ...
  about: [
    `저는 데이터를 이해하는 장벽을 낮추는 시각화 툴을 디자인하고 개발합니다. 
  특히 제 연구 비전은 '시각화를 통한 머신러닝 모델 해석과 개선'에 있습니다. 
  머신러닝 모델은 높은 성능에도 불구하고 해석과 디버깅이 어렵다는 이유로 활용이 어렵곤 합니다. 
  머신러닝 모델의 행동 패턴을 이해하는 것은 인공지능 모델을 개선하고 활용하는데 위해 필수적입니다. 
  머신러닝 모델을 이해하기 어려운 이유는 학습에 데이터, 모델 구조, 그리고 하이퍼 파라미터를 비롯한 다양한 변수가 사용되기 때문입니다. 
  데이터 시각화는 방대한 데이터 속에서 패턴을 찾는다는 강점이 있습니다. 
  따라서 데이터 시각화는 인공지능 설명에 핵심 역할을 할 수 있습니다.`,
