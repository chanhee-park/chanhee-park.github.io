  ...
  experiences: [
    {
      ...
      제가 인턴으로 들어간 시점은 NSML의 새로운 버전을 기획하기 시작한 때 였습니다. 
      좋은 서비스를 만들기 위해 위해 글로벌 기업의 AI 관련 서비스 조사했습니다. 
      디자이너가 없는 팀 상황에 기여하기 위해 어도비 XD 툴을 익혀 Web UI 디자인 업무를 도맡았습니다.
      React Functional components와 Material-UI, TypeScript 등의 기술을 통해 빠르게 프로토타입을 만들어 제안한 기능이 논리적으로 작동하는지 검증했습니다. 
      인턴 기간동안 애자일 프로세스와 깃을 통한 유연하고 긴밀한 협업 프로세스에 익숙해졌습니다.
