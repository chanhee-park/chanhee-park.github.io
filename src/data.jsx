  ...
  experiences: [
    {
      ...
      기존 서비스를 개선하기 위해 위해 글로벌 기업의 AI 관련 서비스 조사하고 NSML 플랫폼 설계에 적용시켰습니다. 
      뿐만 아니라, 사용자를 직접 인터뷰하고 서비스 사용 기록을 분석하여 어떤 방향으로 플랫폼이 나아가야할지 동료들과 함께 고민했습니다. 
      ...
      인턴 동안 애자일 프로세스와 깃을 통한 유연하고 긴밀한 협업 프로세스에 익숙해졌습니다.
      뿐만 아니라, ML 연구자 및 엔지니어의 작업 과정과 에로사항에 대한 이해도를 높일 수 있었습니다. 
      저의 연구가 ML 현업 종사자에게 보다 도움이 되는 방향으로 나아갈 수 있도록 돕는 귀중한 경험이었습니다. 
      `,
    },
    {
