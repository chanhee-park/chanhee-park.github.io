const Data = {
  introCard: {
    title: "방문해주셔서 감사합니다!",
    paragraphs: [`데이터를 참신한 아이디어로 바꿀 방법을 찾고 계신가요? 
  ...
  experiences: [{
    ...
    story: [`캘리포니아 주립대학 데이비스 캠퍼스 컴퓨터공학과의 데이터 시각화 연구실 VIDI Labs에서 방문연구원으로 근무했습니다. 
          ...
          같은 데이터를 표현하는 다양한 시각화 알고리즘을 비교하고 여러 시각화를 조합하여 유저의 인터랙션을 유도하는 방법을 조사하고 적용시켰습니다.`, `리서치와 아이디어 제안, 프로토타이핑을 통한 검증이 순환되며 효율적인 연구가 진행되었습니다. 
    ...
    story: [`학생들의 진로 및 학습 설계를 보조하는 웹 서비스인 미디어-인더스트리 링크의 유지 보수를 맡았습니다.
    ...
    story: [`학교의 현장실습 프로그램으로 파견되어 인연을 맺었습니다. 파견 기간 종료 이후에도 2년간 프로젝트 단위로 프리랜서처럼 함께했습니다. 
          ...
          더더랩에서 근무하는 동안 웹 프론트엔드 개발 및 데이터 시각화를 맡으며 Javascript, TypeScript, Vue, d3.js, Firebase, Redis 등 다양한 웹 개발 기술 스택을 쌓았습니다.`, `* 프로젝트 단위로 3~6개월씩 탄력적으로 근무했습니다.`]
  }],
  educations: [{
    course: "기술경영학 박사과정",
    where: "한양대학교",
  ...
  researches: [{
    id: "visml",
    title: "Analytics System for Machine Learning Model: Focusing on Visual Analysis Methods to Explore the Effect of Changes in Input Variables on Model Prediction",
