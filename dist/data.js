const Data = {
  ...
  experiences: [{
    ...
    story: [`네이버 클로바 AI의 NSML(Naver Smart Machine Learning)팀은 머신러닝 실무자를 돕기 위한 위한 서비스를 개발합니다. 
    ...
    story: [`학생들의 진로 및 학습 설계를 보조하는 웹 서비스인 미디어 인더스트리 링크의 개발을 맡았습니다. 
    ...
    story: [`더더랩은 소프트웨어 외주 개발 업체입니다. 학교의 현장실습 프로그램으로 파견되어 연을 맺었습니다. 
